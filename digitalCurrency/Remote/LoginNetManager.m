...
+(void)getMobilePhoneForTel:(NSString *)tel withcountry:(NSString*)country withgeetest_challenge:(NSString*)challenge withgeetest_validate:(NSString*)validate withgeetest_seccode:(NSString*)seccode CompleteHandle:(void(^)(id resPonseObj,int code))completeHandle{
    ...
    [self noTokenRequestWithPost:path parameters:dic successBlock:^(id resultObject, int isSuccessed) {
...
+(void)getMnemonicForUsername:(NSString *)username code:(NSString *)code completeHandle:(void(^)(id resPonseObj,int code))completeHandle{
    
    NSString *path = @"uc/register/getMnemonic";
    NSMutableDictionary *dic = [NSMutableDictionary new];
    dic[@"username"] = username;
    dic[@"promotion"] = code;
...
+(void)validationMnemonic:(NSDictionary *)param completeHandle:(void(^)(id resPonseObj,int code))completeHandle{
    
    NSString *path = @"uc/register/validationMnemonic";
    
    [self noTokenRequestWithPost:path parameters:param successBlock:^(id resultObject, int isSuccessed) {
        completeHandle(resultObject,isSuccessed);
    }];
...
+(void)registerMnemonic:(NSDictionary *)param completeHandle:(void(^)(id resPonseObj,int code))completeHandle{
    
    NSString *path = @"uc/register/mnemonic";
...
+(void)importMnemonic:(NSDictionary *)param completeHandle:(void(^)(id resPonseObj,int code))completeHandle{
    
    NSString *path = @"uc/importMnemonic";
