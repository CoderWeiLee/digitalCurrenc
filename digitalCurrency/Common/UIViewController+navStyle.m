...
-(void)RightsetupNavgationItemWithpictureName:(NSString*)picturename{
    ...
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithCustomView:tradeButton];
...
- (void)LeftsetupNavgationItemWithpictureName:(NSString*)picturename{
    ...
    UIBarButtonItem *leftItem = [[UIBarButtonItem alloc] initWithCustomView:tradeButton];
...
//    [item setTintColor:AppTextColor_Level_1];
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:AppTextColor_Level_1,NSForegroundColorAttributeName,[UIFont boldSystemFontOfSize:14],NSFontAttributeName ,nil];
