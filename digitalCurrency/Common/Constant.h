...
//主色调
#define mainColor  RGBOF(0xFFFFFF)
#define baseColor  RGBOF(0xF4F4F4)
...
#define AppTextColor_Level_2 RGBOF(0x6B6B6B)
#define AppTextColor_Level_3 AppTextColor_999999


#define RedColor   RGBOF(0xEF456E)   //红跌
#define GreenColor RGBOF(0x01B77E)  //绿涨
