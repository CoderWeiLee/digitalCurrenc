...
//    return [EmptyDataView emptyActionViewWithImageStr:@"nodata" titleStr:@"暂无数据"
//                                   detailStr:@"请检查您的网络连接是否正确!"];
    
    
    return [EmptyDataView emptyActionViewWithImageStr:@"noData" titleStr:@"暂无数据" detailStr:@"请检查你的网络连接是否正确!" btnTitleStr:@"重新加载" btnClickBlock:^{
