...
- (HJDropDownMenu *)creatMenuWithTitles:(NSArray *)titles{
    ...
    yearMenu.backgroundColor = AppTextColor_Level_3;
    yearMenu.rowHeight = 35;
    yearMenu.datas = titles;
    yearMenu.textColor = AppTextColor_Level_2;
    return yearMenu;
}
...
//    headerBtn.layer.borderWidth = 0.5;
    ...
    [headerBtn setBackgroundColor:RGBOF(0xF9F9F9)];
...
- (UIView *)bottomCancleBtn{
    ...
    for (int i = 0; i < 2; i++) {
        ...
        if (i == 0) {
            headerBtn.layer.borderColor = AppTextColor_Level_3.CGColor;
            headerBtn.layer.borderWidth = 1;
            [headerBtn setBackgroundColor:[UIColor whiteColor]];
            [headerBtn setTitleColor:AppTextColor_Level_1 forState:UIControlStateNormal];
        }
        else{
            headerBtn.layer.borderColor = AppTextColor_Level_3.CGColor;
            headerBtn.layer.borderWidth = 0;
            [headerBtn setBackgroundColor:RGBOF(0x1995FE)];
...
- (void)addEntrustSubViewsWithTypes:(NSArray *)types{
    ...
    subTimeLabel.textColor = AppTextColor_Level_2;
...
-(void)staretimeaction{
    ...
    datePickManager.headerViewBackgroundColor = AppTextColor_Level_3;
    datePickManager.titleLabel.text = LocalizationKey(@"startTime");
    datePickManager.titleLabel.textColor = [UIColor grayColor];
    //设置确定按钮的字体颜色
    datePickManager.confirmButtonTextColor = RGBOF(0x1995FE);
    //设置选中行的字体颜色
    datePicker.textColorOfSelectedRow = AppTextColor_Level_1;
    //设置线条的颜色
