...
-(void)getDetailNotice: (PlatformMessageModel *) model{
    NSString *path = [NSString stringWithFormat:@"%s%@","/uc/announcement/",model.ID];
...
//    detailVC.urlString = [NSString stringWithFormat:@"%s%@","/uc/announcement/",model.ID];
//    [[AppDelegate sharedAppDelegate] pushViewController:detailVC];
    [self getDetailNotice:model];
}
