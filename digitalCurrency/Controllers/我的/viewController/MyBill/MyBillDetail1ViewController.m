...
//        UIBarButtonItem*item = [[UIBarButtonItem alloc]initWithTitle:[[ChangeLanguage bundle] localizedStringForKey:@"contactMe" value:nil table:@"English"] style:UIBarButtonItemStylePlain target:self action:@selector(RighttouchEvent)];
//        [item setTintColor:AppTextColor_Level_1];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        cell.rightLabel.textColor = AppTextColor_Level_2;
...
-(void)fangKuanAlterView{
    ...
    .LeeAddTextField(^(UITextField *textField){
        ...
        textField.layer.borderColor = kRGBColor(18, 22, 28).CGColor;
