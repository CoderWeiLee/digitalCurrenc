...
- (void)viewDidLoad {
    ...
    [btn setTitleColor:RGBOF(0x1995FE) forState:UIControlStateNormal];
...
- (void)creatUI{
    ...
    label.textColor = AppTextColor_Level_2;
    ...
    [tipBtn setTitleColor:RGBOF(0x1995FE) forState:UIControlStateNormal];
...
- (void)tipPicture{
    ...
    [model0 setImageWithFileName:@"WechatIMG2102" fileType:@"jpg"];
