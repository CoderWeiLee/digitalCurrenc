...
- (void)awakeFromNib {
  ...
  //  [self.titlelabel3 setTitle:LocalizationKey(@"myPromotion") forState:UIControlStateNormal];
    ...
    self.Butview3.layer.masksToBounds = YES;
    self.Butview3.layer.cornerRadius = self.Butview3.height / 2;
    
    
    self.backview.layer.masksToBounds = YES;
    self.backview.layer.cornerRadius = 3;

    self.titlelabel.text = LocalizationKey(@"minefuck3");
    if (kWindowW == 320) {
