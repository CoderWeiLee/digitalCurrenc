...
- (void)awakeFromNib {
    ...
    self.titleview.text = LocalizationKey(@"minefuck1");;
...
//    NSArray *imagearray = @[@"wd_zc",@"wd_zcls",@"wd_jywk",@"wd_cbfh",@"wd_blc",@"图层 633"];
    NSArray *namearray = @[LocalizationKey(@"Myassets"),LocalizationKey(@"Assetflow"),LocalizationKey(@"BECOME2"),LocalizationKey(@"BECOME")];
    NSArray *imagearray = @[@"我的资产",@"资产流水",@"身份认证",@"资金密码"];
