...
//    [self.tableView registerNib:[UINib nibWithNibName:@"menuCell" bundle:nil] forCellReuseIdentifier:@"menuCell"];
    ...
    self.tableView.tableFooterView=[UIView new];
     [_defalutBtn setTitleColor:RGBOF(0x1995FE) forState:UIControlStateNormal];
...
- (IBAction)changeData:(UIButton *)sender {
    ...
    if (sender!=_currentBtn) {
        [_currentBtn setTitleColor:AppTextColor_Level_3 forState:UIControlStateNormal];
        [sender setTitleColor:RGBOF(0x1995FE) forState:UIControlStateNormal];
        _currentBtn=sender;
