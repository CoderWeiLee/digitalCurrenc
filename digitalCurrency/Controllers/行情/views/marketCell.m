...
- (void)awakeFromNib {
    ...
    self.nameLabel.textColor = AppTextColor_Level_1;
    self.moneyLabel.textColor = AppTextColor_Level_1;
    self.baseLabel.textColor = AppTextColor_Level_2;
    self.tradeNumbel.textColor = AppTextColor_Level_2;
    self.cnyLabel.textColor = AppTextColor_Level_2;
}
