...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (![YLUserInfo isLogIn]) {
        ...
        if (index==3) {
            ...
            self.ctrlContanier.mj_offsetY = 0;
...
-(UIScrollView *)ctrlContanier
{
    if (!_ctrlContanier) {
        ...
        _ctrlContanier.frame = CGRectMake(0, CGRectGetMaxY(_segment.frame)-1, kWindowW, ([DCConstant appHeight] - [DCConstant appTabBarHeight] - [DCConstant appNavBarHeight] - _segment.height));
