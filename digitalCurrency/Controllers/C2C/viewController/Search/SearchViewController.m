...
- (UIButton *)magicView:(VTMagicView *)magicView menuItemAtIndex:(NSUInteger)itemIndex {
    ...
    if (!menuItem) {
        ...
        [menuItem setTitleColor:kRGBColor(174, 124, 0) forState:UIControlStateSelected];
